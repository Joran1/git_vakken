		...
		<form action="Controller?action=productUpdateConfirmed" method="post">
			...
			<p>
				<label for="name">naam</label> <input id="name" name="name"
					type="text" value="<c:out value='${name}'/>"/>
			</p>
			<p>
				<label for="description">description</label> <input id="description"
					name="description" type="text" value="<c:out value='${description}'/>"/>
			</p>
			<p>
				<label for="price">price</label> <input id="price" name="price"
					type="text" value="<c:out value='${price}'/>"/>
			</p>
			<input type="submit" />
		</form>
		<jsp:include page="footer.jsp">
			<jsp:param name="page" value="productUpdateConfirmed" />
		</jsp:include>
	</div>
</body>
</html>